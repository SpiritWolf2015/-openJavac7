...
/**
 * Main类运行例子：在Program arguments里填入想要编译的Java文件路径:
 * E:\HelloWorld.java，即可编译生成对应的.class文件。<p>
 *
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1 || !"-Xjdb".equals(args[0])) {
            System.out.println(String.format("compile .java,path=[%s]", args[0]));
