 ...
 * ZipFileIndexArchive类是默认操作所有压缩包的类，Javac用这个类来读取ct.sym及JAR包中的内容。
 * </b>
 */
public class ZipFileIndexArchive implements Archive {
    ...
    public ZipFileIndexArchive(JavacFileManager fileManager, ZipFileIndex zdir) {
        super();
    ...
    public JavaFileObject getFileObject(RelativeDirectory subdirectory, String file) {
        ...
        return new ZipFileIndexFileObject(fileManager, zfIndex, entry, zfIndex.getZipFile());
    }
