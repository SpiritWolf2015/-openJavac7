...
public class ClassReader implements Completer {
   ...
   /** Lint option: warn about classfile issues
    ...
    /**
     * 在Javac中，同一个包或类和接口需要使用同一个PackageSymbol或ClassSymbol对象来表示。为了能达到重用的目的，需要对已经创建的对象进行缓存。<p>
 ...
 ***********************************************************************/
    ...
    public ClassSymbol defineClass(Name name, Symbol owner) {
        // 首先创建ClassSymbol对象，然后将这个对象的completer值设置为当前的ClassReader对象，这样就可以调用completer的complete()方法完成类中成员符号的填充了
