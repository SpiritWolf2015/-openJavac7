...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    public static class JCCompilationUnit extends JCTree implements CompilationUnitTree {
        ...
        /**
         * 依赖处理，通过导入声明导入的依赖对应的符号会填充到JCCompilationUnit的namedImport-Scope变量中，同一个编译单元中定义的所有顶层类也会填充到这个变量中。
         * 不同编译单元下的类在编译时可能会依赖同一个类型，那么最终填充到不同编译单元的namedImportScope变量中的ClassSymbol对象也会是同一个。
         */
